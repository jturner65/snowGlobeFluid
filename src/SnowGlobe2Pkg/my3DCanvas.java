...
public class my3DCanvas {
	...
	public my3DCanvas(SnowGlobeWin _p) {
		p = _p;
	...
	public void buildCanvas(){	
		...
		eyeInWorld = getEyeLoc();//pick(viewDimW/2, viewDimH/2,-.00001f);
...
class edge{ 
	public SnowGlobeWin p;
	public myPoint a, b;
	public edge (SnowGlobeWin _p){this(_p,new myPoint(0,0,0),new myPoint(0,0,0));}
	public edge (SnowGlobeWin _p, myPoint _a, myPoint _b){p = _p;a=new myPoint(_a); b=new myPoint(_b);}
